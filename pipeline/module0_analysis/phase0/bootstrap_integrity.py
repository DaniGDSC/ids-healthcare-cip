...
Usage:
    python -m pipeline.module0_analysis.phase0.bootstrap_integrity \\
        [--config pipeline/module0_analysis/phase0/config.yaml]
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="python -m pipeline.module0_analysis.phase0.bootstrap_integrity",
        description=(
    ...
    verifier = IntegrityVerifier(
        metadata_dir=workspace / "pipeline/module0_analysis/phase0",
    )
    try:
