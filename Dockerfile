...
LABEL version="7.0" \
      description="IDS Healthcare CIP — Phase 0-6 pipeline" \
      maintainer="analyst"
...
# ── Dependencies (Phase 0–6: includes shap, matplotlib, plotly) ──────
...
RUN mkdir -p data/processed data/phase2 data/phase3 data/phase4 \
             data/phase5 data/phase5/charts data/phase6 \
             models/scalers results/phase0_analysis \
    && chown -R analyst:analyst /home/analyst/app

USER analyst

# ── Health check: verify Phase 0–6 imports + shap importable ─────────
...
from src.phase6_notification_engine.phase6_notification import PriorityRouter; \
