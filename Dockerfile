...
LABEL version="5.0" \
      description="IDS Healthcare CIP — Phase 0 + Phase 1 + Phase 2 + Phase 3 + Phase 4 pipeline" \
      maintainer="analyst"
...
# ── Health check: verify Phase 0–4 imports + baseline exportability ──
...
import tensorflow as tf; import json, pathlib; \
