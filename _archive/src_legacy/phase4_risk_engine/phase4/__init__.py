...
AttentionAnomalyDetector     — novelty/zero-day (from phase2)
...
ConditionalExplainer        — severity-based explainability (from phase5)
CognitiveTranslator         — stakeholder views (from dashboard/utils)
