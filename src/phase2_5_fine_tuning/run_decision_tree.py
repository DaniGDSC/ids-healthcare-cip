...
Usage:
    python src/phase2_5_fine_tuning/run_decision_tree.py
    python src/phase2_5_fine_tuning/run_decision_tree.py --n-iter 25 --cv-folds 5
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir",
        default="data/phase2/decision_tree",
    )
    ...
    logger.info(sep)
    logger.info("PHASE 2 — DECISION TREE FINE-TUNING")
    logger.info(sep)
    ...
    report_path = output_dir / "decision_tree_report.json"
    ...
    logger.info("")
    logger.info(sep)
    logger.info("DECISION TREE FINE-TUNING SUMMARY")
    logger.info(sep)
